...
import { getSpecificFund, url } from "../api/apis";
...
const FundDetail = () => {
  ...
  return (
    <Container maxW={"7xl"} overflow="auto">
      <VStack spacing={4} py={5}>
        {/* Fund Header */}
        <SimpleGrid columns={[1, 1, 2]} spacing={10} w="100%">
          <GridItem colSpan={1}>
            <HStack bg="white" rounded="lg" px={6} py={4}>
              ...
              <VStack>
                ...
                <HStack>
                  <Button
                    ...
                    bgColor="blue.400"
                    color={"white"}
                    onClick={() => navigate("/buy/" + specificFund?._id)}
                  >
                    Invest
                  </Button>
                  <Button
                      ...
                      if (navigator.share) {
                        navigator
                          .share({
                            ...
                            url: websiteURL + "/fund/" + specificFund?._id,
                          })
                        ...
                        navigator.clipboard.writeText(
                          websiteURL + "/fund/" + specificFund?._id
                        );
                        toast({
                          title: "Copied",
        ...
        {/* CALCULATOR */}
        <Box w="100%" py={6}>
          <Stack justifyContent="space-evenly" direction="row" w="100%">
            <HStack>
        ...
        <SimpleGrid columns={[1, 1, 3]} spacing={10} w="100%">
          ...
          <GridItem bg="white" rounded="lg" px={6} py={4} overflow="hidden">
            <Heading fontSize="2xl" color="gray.600">
              Description of Fund
            </Heading>
